...
use a\TravelBundle\Entity\Hotel;
use a\TravelBundle\Form\HotelType;
...
class HotelController extends Controller
{
    ...
    {
        $hotel = new Hotel();
        $form = $this->createForm('a\TravelBundle\Form\HotelType', $hotel);
    ...
    {
        $deleteForm = $this->createDeleteForm($hotel);
        $editForm = $this->createForm('a\TravelBundle\Form\HotelType', $hotel);
