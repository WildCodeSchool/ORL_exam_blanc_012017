...
use a\TravelBundle\Entity\Room;
use a\TravelBundle\Form\RoomType;
...
class RoomController extends Controller
{
    ...
    {
        $room = new Room();
        $form = $this->createForm('a\TravelBundle\Form\RoomType', $room);
    ...
    {
        $deleteForm = $this->createDeleteForm($room);
        $editForm = $this->createForm('a\TravelBundle\Form\RoomType', $room);
